...
import { mariaModalP } from "../data/data";

const MariaModal: FC<ModalProps> = ({ open, setOpen }) => {
              ...
              <div className="bg-[#FFDAB9] px-4 pb-4 pt-3 md:pt-5 sm:p-6 sm:pb-4">
                ...
                <section className="w-full">
                  <div className="mt-2 md:mt-4 flex justify-center w-full">
                    <img src={img1} className="w-64" alt="happy birthday" />
                  </div>
                  <div className="mt-2 md:mt-4 w-full">
                    {mariaModalP.map((p, index) => (
