...
import { pedroModalPs } from "../data/data";

const PedroModal: FC<ModalProps> = ({ open, setOpen }) => {
                ...
                <section className="w-full">
                  ...
                  <div className="mt-2 md:mt-4 w-full">
                    <p className="mb-5 text-lg">
                      {pedroModalPs.p1}
                      <span className="font-playwrite-dk-uloopet">
                        {pedroModalPs.name}
                      </span>
                    </p>
                    <p className="mb-5 text-lg">{pedroModalPs.p2}</p>
                    <p className="mb-5 text-lg">{pedroModalPs.p3}</p>
